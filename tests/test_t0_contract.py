...
class T0ContractTest(unittest.TestCase):
    ...
    def test_release_package_includes_maintenance_scripts(self):
        ...
        self.assertIn('cp "$ROOT_DIR/scripts/taskboard_cold_resume_smoke.py"', package_script)
        self.assertIn('cp "$ROOT_DIR/scripts/taskboard_cold_resume_acceptance.py"', package_script)
        self.assertIn('cp "$ROOT_DIR/scripts/taskboard_framework_readiness.py"', package_script)
        self.assertIn('cp "$ROOT_DIR/scripts/taskboard_overnight_field_run.py"', package_script)
        self.assertIn('cp "$ROOT_DIR/scripts/taskboard_live_milestone_acceptance.py"', package_script)
    ...
    def test_worker_idle_recheck_refreshes_liveness(self):
        ...
        self.assertIn("generated bundled-script `taskboard.py ... cycle T{N}` command", role_t0)
        self.assertIn("do not terminate or cancel the client `/loop`", role_t0)
    ...
    def test_terminal_launcher_contract_is_documented(self):
        ...
        self.assertIn("taskboard-T*.launch.ps1", role_t0)
        self.assertIn("bootstrap-refreshes `.taskboard/alive/T{N}`", role_t0)
        self.assertIn("TASKBOARD_TARGET_FILE", role_t0)
        self.assertIn("/loop 2m /taskboard-dev T{N}", role_t0)
        self.assertIn("UTF-8 target file", role_t0)
        ...
        self.assertIn("taskboard-T*.launch.ps1", readme)
        self.assertIn("bootstrap-refresh `.taskboard/alive/T{N}`", readme)
        self.assertIn("powershell -File", readme)
        self.assertIn("TASKBOARD_TARGET_FILE", readme)
        self.assertIn("/loop 2m /taskboard-dev T{N}", readme)
        self.assertIn("UTF-8 target", readme)
        ...
        self.assertIn("python scripts/taskboard_cold_resume_smoke.py", readme)
        self.assertIn("python scripts/taskboard_cold_resume_acceptance.py --root .", readme)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . start --run-id", readme)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . resume", readme)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . verify", readme)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . status", readme)
        self.assertIn("python scripts/taskboard_framework_readiness.py --root .", readme)
        self.assertIn("completion sentinel/dev-log", readme)
        self.assertIn("progress 进入 `complete`", readme)
        self.assertIn("python scripts/taskboard_live_milestone_acceptance.py --root .", readme)
        self.assertIn("真实 T0-managed milestone", readme)
        ...
        self.assertIn("cold_resume_readiness", readme)
        self.assertIn("cold_resume_readiness", manual)
        self.assertIn("cold_resume_readiness", template)
        self.assertIn("python scripts/taskboard_framework_readiness.py --root .", manual)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . start --run-id", manual)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . resume", manual)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . verify", manual)
        self.assertIn("python scripts/taskboard_overnight_field_run.py --root . status", manual)
        self.assertIn("taskboard_overnight_field_run.py --root . start --run-id", template)
        self.assertIn("taskboard_overnight_field_run.py --root . status", template)
        self.assertIn("taskboard_framework_readiness.py --root .", template)
        self.assertIn("field-verification-required", template)
        ...
        self.assertIn("python scripts/taskboard.py --root . launch-probe --launcher windows-terminal", template)
    ...
    def test_shared_checkout_coordination_contract_is_documented(self):
        ...
        self.assertIn(".taskboard/t0/checkout-owner.json", skill)
        self.assertIn("checkout_owner_state=conflict", skill)
        self.assertIn("ClaudeCode and Codex are editing different files", skill)
        self.assertIn("Shared checkout ownership", role_t0)
        self.assertIn("Checkout-owner launch guard", role_t0)
        ...
        self.assertIn(".taskboard/t0/checkout-owner.json", manual)
        self.assertIn("only one may own the same Git checkout", readme)
        self.assertIn("--checkout-owner-id", readme)
