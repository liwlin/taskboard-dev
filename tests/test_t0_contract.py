...
class T0ContractTest(unittest.TestCase):
    ...
    def test_terminal_launcher_contract_is_documented(self):
        ...
        self.assertIn('claude --taskboard-target-file "{target_file}"', role_t0)
        self.assertIn("Get-Content -Raw -LiteralPath", role_t0)
        ...
        self.assertIn("Get-Content -Raw -LiteralPath", readme)
