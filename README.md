...
If an executed launcher command fails, the loop action reports `T0 launch/recovery failed` and tells the user to fix T0 launcher configuration or retry another launcher, not to manage T1/T2/T3 directly.
