...
- T0 stops only when the active TASK queue is empty and `docs/STATE.md` contains `**Goal Complete**: yes` or `Goal Complete: yes`. Empty queue without that completion sentinel means the goal is still incomplete and T0 should wake T1 to create or revise TASK files.
